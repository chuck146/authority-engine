          ...
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/10 transition-all hover:-translate-y-1 hover:bg-[#4CB848]"
              >
              ...
              {services.slice(0, 6).map((s) => (
                <li key={s.slug}>
                  <Link
                    ...
                    className="text-[0.95rem] text-white/60 transition-colors hover:text-[#4CB848]"
                  >
                    {s.title}
                  </Link>
                </li>
              ...
              {phone && (
                <div>
                  ...
                  <a
                    ...
                    className="text-[0.95rem] font-medium text-white transition-colors hover:text-[#4CB848]"
                  >
                    {phone}
                  </a>
                </div>
